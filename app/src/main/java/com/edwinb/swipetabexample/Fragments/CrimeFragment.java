...
public class CrimeFragment extends Fragment
{
    ...
    private ArrayList<Movie> getCrimeMovies()
    {
        ...
        Movie movie = new Movie("BLACKLIST", R.drawable.drummer_music_news);
        movies.add(movie);

        movie = new Movie("Breaking Bad", R.drawable.drum_beats);
        movies.add(movie);

        movie = new Movie("Crisis", R.drawable.drum_fills);
        movies.add(movie);

        movie = new Movie("Blacklist", R.drawable.drum_kit_news);
        movies.add(movie);

        movie = new Movie("Men In Black", R.drawable.drum_theory_notation);
        movies.add(movie);
